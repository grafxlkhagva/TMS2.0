...
interface CustomerStatsProps {
    customers?: Customer[]; // Optional because it might be used on detail page with single customer context or general stats
    isLoading: boolean;
    // If used for single customer stats, we might pass different props, but for now let's reuse logic from dashboard
    // Assume if customers is passed, it's global stats.
}

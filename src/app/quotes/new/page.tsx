  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
      ...
      toast({
        variant: 'destructive',
        title: 'Алдаа',
        description: 'Үнийн санал бүртгэхэд алдаа гарлаа. Та дахин оролдоно уу.',
      });
      setIsSubmitting(false);
    }
  }
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <Card>
            <CardHeader>
                ...
                <CardDescription>Үнийн саналын дэлгэрэнгүй тээвэрлэлтийн мэдээллийг дараагийн алхамд оруулна.</CardDescription>
            </CardHeader>

...
export default function VehicleMakesPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      // TODO: Check if any model is associated with this make before deleting
      await deleteDoc(doc(db, 'vehicle_makes', itemToDelete.id));
      toast({ title: 'Амжилттай', description: 'Үйлдвэрлэгч устгагдлаа.' });
      fetchItems();
    } catch (error) {
  ...
  return (
    <div className="container mx-auto py-6">
       <div className="mb-6">
        ...
        <h1 className="text-3xl font-headline font-bold">Машины үйлдвэрлэгч</h1>
        <p className="text-muted-foreground">
          Машины үйлдвэрлэгчдийн лавлах санг удирдах.
        </p>
      </div>

    ...
    try {
        ...
        orderItems.forEach((item: any, index: number) => {
            ...
            row.values = [
                ...
                `${getDetailName('regions', item.startRegionId)}, ${getDetailName('warehouses', item.startWarehouseId)}`,
                `${getDetailName('regions', item.endRegionId)}, ${getDetailName('warehouses', item.endWarehouseId)}`,
